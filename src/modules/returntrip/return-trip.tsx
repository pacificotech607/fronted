...
import ReturnTripUnit from './return-trip-unit';
...
const ReturnTrip: React.FC = () => {
    ...
    const handleSearch = (query: string | null) => {
        ...
        const status = viewHistory ? statusBls.returnReviewTrip.value : statusBls.exitReviewTrip.value;
    ...
    const handleToggleView = () => {
        ...
        const status = newViewHistory ?  statusBls.returnReviewTrip.value : statusBls.exitReviewTrip.value;
        const baseQuery = blsAggregateAssignPort;
    ...
    return (
        <div className="app-main">
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-sm-6">
                            <h3 className="mb-0">Regreso a viaje</h3>
                        </div>
                                    ...
                                    <td className='text-center'>
                                        {!viewHistory && (
                                            <button
                                                ...
                                                data-bs-target="#blsReturnTripModal"
                                                onClick={() => setBl(bl)}
                                                title="Revisar regreso"
                                                disabled={Object.values(statusBls).find(s => s.value === bl.status)?.value !== statusBls.exitReviewTrip.value}
                                            >
            ...
            <ReturnTripUnit bls={bl} refresh={() => { dispatch(getEntities(0, 20, searchQuery || undefined)); }} />
        </div>
    );
};
