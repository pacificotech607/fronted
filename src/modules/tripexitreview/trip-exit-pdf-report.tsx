...
interface TripExitPdfReportProps {
    bl: IBLS | null;
    onClose: () => void;
}

const TripExitPdfReport: React.FC<TripExitPdfReportProps> = ({ bl, onClose }) => {
    ...
    const generatePdf = () => {
        if (reportRef.current) {
            html2canvas(reportRef.current, { useCORS: true }).then(canvas => {
                ...
                pdf.save(`reporte-salida-viaje-${bl?.bl || 'N/A'}.pdf`);
            });
        }
    };
                ...
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <div ref={reportRef} style={{ padding: '20px' }}>
                            <h1 className="text-center mb-4">Reporte de Salida de Viaje</h1>
...
export default TripExitPdfReport;
