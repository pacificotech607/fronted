...
import AssignPortUnit  from './assign-port-unit';

const AssignPort: React.FC = () => {
    ...
    const handleToggleView = () => {
        ...
        const status = newViewHistory ? statusBls.assignedPort.value : statusBls.inactive.value;
        const baseQuery = blsAggregateAssignPort;
    ...
    return (
        <div className="app-main">
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-sm-6">
                            <h3 className="mb-0">Asignar unidades a puerto</h3>
                        </div>
                            ...
                            {bls && bls.map((bl, i) => (
                                <tr key={`entity-${i}`} className="align-middle">
                                    ...
                                    <button
                                        ...
                                        data-bs-target="#blsAssignPortModal"
                                        onClick={() => setBl(bl)}
            ...
            <AssignPortUnit bls={bl} refresh={() => { dispatch(getEntities(0, 20, searchQuery || undefined)); }} />
        </div>
    );
};

export default AssignPort;
